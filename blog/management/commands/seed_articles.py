...
ARTICLE_TEMPLATES = [
    {
        ...
        'content': '''{topic} — один из ключевых инструментов современного разработчика.
...
''',
    },
    {
        ...
        'content': '''Переход на продакшен — ответственный шаг. Разберём как правильно настроить {topic}.
...
''',
    },
    {
        ...
        'content': '''Производительность важна. Рассмотрим как ускорить работу с {topic}.
...
''',
    },
    {
        ...
        'content': '''Тесты — это не скучно, это необходимость. Разберём как тестировать {topic}.
...
''',
    },
    {
        ...
        'content': '''Выбор инструмента — важное решение. Сравним {topic} с конкурентами.
...
''',
    },
    {
        ...
        'content': '''Хочу поделиться личным опытом использования {topic} в реальных проектах.
...
''',
    },
    {
        ...
        'content': '''Собрал лучшие практики работы с {topic} за 5 лет.
...
''',
    },
    {
        ...
        'content': '''История моего перехода на {topic}.
